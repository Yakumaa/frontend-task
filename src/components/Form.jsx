...
const Form = ({ schema }) => {
  ...
  const renderInput = (field) => {
    ...
    switch (type) {
      case 'textarea':
        return <TextareaInput key={name} {...commonProps} />;
      case 'checkbox':
        return <CheckboxInput key={name} {...commonProps} />;
      case 'select':
        return <SelectInput key={name} {...commonProps} options={options} />;
      default:
        return <TextInput key={name} {...commonProps} type={type} formData={formData}/>;
    }
  };
